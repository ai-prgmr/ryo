...
export default function RollingPaperManufacturerPage() {
  const organizationSchema = {
    ...
    "description": "Premier manufacturer and global supplier of high-quality custom rolling papers, private label solutions, and sustainable rolling paper materials since 2017.",
    "foundingDate": "2017",
    "contactPoint": {
      "@type": "ContactPoint",
    ...
    <div className={`bg-white text-[#1A1612] ${dmSans.variable} ${playfair.variable} font-sans leading-relaxed overflow-x-hidden`}>
      ...
      <section className="min-h-[88vh] grid grid-cols-1 md:grid-cols-2 items-center py-20 px-[clamp(20px,5vw,80px)] gap-[60px] relative overflow-hidden" aria-label="Hero">
        ...
        <div className="relative z-10">
          ...
          <FadeUp delay={0.1}>
            <h1 className="font-[var(--font-playfair)] text-[clamp(38px,5.5vw,68px)] font-black leading-[1.05] tracking-tight text-[#1A1612] mb-6">
              Rolling Paper <em className="italic text-[#3B5E3A] font-bold">Manufacturer</em> You Can Build a Brand On
            </h1>
          </FadeUp>
          <FadeUp delay={0.2}>
          ...
          <FadeUp delay={0.3}>
            <div className="flex gap-3.5 flex-wrap mb-12">
              <Link href="/contact" className="bg-[#C9A961] hover:bg-[#B8860B] text-white py-3.5 px-8 rounded-sm text-sm font-medium tracking-wider uppercase transition-all duration-200 inline-block">
                Request a Sample
              </Link>
              <Link href="#paper-types" className="border-[1.5px] bg-[#87A96B] border-[#1A1612] text-[#1A1612] py-3 px-7 rounded-sm text-sm font-medium tracking-wider uppercase transition-all duration-200 hover:bg-[#B8860B] hover:text-white inline-block">
                View Paper Types
              </Link>
            </div>
          </FadeUp>
          <FadeUp delay={0.4}>
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-[rgba(26,22,18,0.1)]">
              <div>
                <div className="font-[var(--font-playfair)] text-[clamp(28px,3vw,38px)] text-[#3B5E3A] leading-none">2017</div>
                <div className="text-[12px] text-[#7A6F65] tracking-wider uppercase mt-1.5">Founded</div>
              </div>
              <div>
                <div className="font-[var(--font-playfair)] text-[clamp(28px,3vw,38px)] text-[#3B5E3A] leading-none">30+</div>
                <div className="text-[12px] text-[#7A6F65] tracking-wider uppercase mt-1.5">Countries Served</div>
              </div>
              <div>
                <div className="font-[var(--font-playfair)] text-[clamp(28px,3vw,38px)]  text-[#3B5E3A] leading-none">500</div>
        ...
        <FadeUp delay={0.5} className="relative flex items-center justify-center z-10" aria-hidden="true">
          <div className="relative w-[380px] h-[440px] max-w-full">
            ...
            <div className="absolute w-[240px] h-[320px] rounded-md border border-[rgba(26,22,18,0.1)] flex flex-col items-center justify-center p-6 bg-[#EBF2EB] top-0 left-0 rotate-[4deg] translate-x-[40px] -translate-y-[10px] shadow-[0_18px_50px_rgba(26,22,18,0.1)]">
              <div className="text-[56px] mb-4">📜</div>
            </div>
            <div className="absolute w-[240px] h-[320px] rounded-md border border-[#3B5E3A] flex flex-col items-center justify-center p-6 bg-white top-0 left-0 translate-x-[70px] translate-y-[60px] shadow-[0_18px_50px_rgba(26,22,18,0.1)]">
              <div className="text-[56px] mb-4">✦</div>
              <div className="font-[var(--font-playfair)] text-[18px] text-[#1A1612] text-center mb-2">Custom Rolling Papers</div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-12">
          {[
            ...
            <div key={i} className="flex items-center gap-2.5 text-[13px] font-medium tracking-wider uppercase text-[#3D3630]">
              <span className="w-9 h-9 border-[1.5px] border-[#3B5E3A] rounded-full flex items-center justify-center text-[#3B5E3A] text-sm font-bold bg-[#EBF2EB]">✓</span>
              {text}
            </div>
          ))}
        </div>
      ...
      <section className="py-24 px-[clamp(20px,5vw,80px)]" id="paper-types">
        <span className="inline-block text-[11px] font-medium tracking-[0.14em] uppercase text-[#3B5E3A] mb-4">What We Manufacture</span>
        <h2 className="font-[var(--font-playfair)] text-[clamp(30px,4vw,48px)] leading-[1.1] tracking-tight text-[#1A1612] mb-5">Every Rolling Paper Type. <em className="italic text-[#3B5E3A] font-bold">One Manufacturer.</em></h2>
        <p className="text-[17px] text-[#3D3630] font-light max-w-[720px] leading-relaxed mb-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <Link key={i} href={item.link} className="bg-white border border-[rgba(26,22,18,0.1)] rounded px-7 py-8 flex flex-col transition-all duration-300 hover:border-[#3B5E3A] hover:-translate-y-1 hover:shadow-[0_12px_30px_rgba(26,22,18,0.06)] group">
              <div className="text-[42px] mb-4.5">{item.icon}</div>
              <div className="font-[var(--font-playfair)] text-[22px] font-bold text-[#1A1612] mb-1.5">{item.name}</div>
              <div className="text-[11px] tracking-[0.08em] uppercase text-[#3B5E3A] font-medium mb-3.5">{item.spec}</div>
              ...
              <span className="mt-3.5 text-[12px] text-[#3B5E3A] uppercase tracking-[0.06em] font-medium group-hover:underline">Explore {item.name} →</span>
            </Link>
          ))}
        </div>
      </section>
      ...
      {/* ── COMPARISON TABLE ── */}
      <section className="py-24 px-[clamp(20px,5vw,80px)] bg-[#FAFAF7]">
        <span className="inline-block text-[11px] font-medium tracking-[0.14em] uppercase text-[#3B5E3A] mb-4">Compare Paper Types</span>
        <h2 className="font-[var(--font-playfair)] text-[clamp(30px,4vw,48px)] leading-[1.1] tracking-tight text-[#1A1612] mb-5">Rice vs Hemp vs Flax vs Wood Pulp vs Cellulose</h2>
        <p className="text-[17px] text-[#3D3630] font-light max-w-[720px] leading-relaxed mb-14">
        ...
        <div className="overflow-x-auto mt-4 border border-[rgba(26,22,18,0.1)] bg-white rounded">
          <table className="w-full min-w-[720px] border-collapse text-left text-sm" aria-label="Comparison of rolling paper types">
            <thead>
              <tr className="bg-[#1A1612] text-white font-[var(--font-playfair)] text-[13px] tracking-wider uppercase font-bold">
            ...
            <tbody className="text-[#3D3630]">
              {[
                ...
                <tr key={i} className="hover:bg-[#FAFAF7] transition-colors border-b border-[rgba(26,22,18,0.06)] last:border-b-0">
                  <th className="p-4 bg-[#F5F2EC] font-[var(--font-playfair)] w-[180px] text-[#1A1612]">{row.label}</th>
                  {row.values.map((val, j) => (
                    <td key={j} className={`p-4 ${j === 0 || (row.label === "Best Brand Fit" && j === 0) ? "bg-[#EBF2EB] font-medium" : ""}`}>
                      {val}
                    </td>
                  ))}
                </tr>
        ...
        <p className="mt-6 text-sm text-[#7A6F65] max-w-[720px]">
          Not sure which type fits your brand? Most new brands launch on rice paper at 14 GSM — it has the broadest appeal across consumer segments and the cleanest first impression. <Link href="/contact" className="text-[#3B5E3A] font-medium underline">Talk to our team →</Link>
        </p>
      </section>

      {/* ── PROCESS ── */}
      <section className="py-24 px-[clamp(20px,5vw,80px)] bg-white">
        <span className="inline-block text-[11px] font-medium tracking-[0.14em] uppercase text-[#3B5E3A] mb-4">How It Works</span>
        <h2 className="font-[var(--font-playfair)] text-[clamp(30px,4vw,48px)] font-black leading-[1.1] tracking-tight text-[#1A1612] mb-5">From Brief to <em className="italic text-[#3B5E3A] font-bold">Brand-Ready</em> in 3–5 Weeks</h2>
        <p className="text-[17px] text-[#3D3630] font-light max-w-[720px] leading-relaxed mb-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-6">
          {[
            ...
            <FadeUp key={i} delay={0.1 * i} className="bg-white border border-[rgba(26,22,18,0.1)] rounded px-6 py-8 relative">
              <div className="font-[var(--font-playfair)] text-[44px] font-black text-[#3B5E3A] leading-none mb-4">{step.num}</div>
              <div className="font-[var(--font-playfair)] text-lg font-bold text-[#1A1612] mb-2 leading-snug">{step.title}</div>
      ...
      {/* ── DATA BAND ── */}
      <section className="bg-[#1A1612] text-white py-24 px-[clamp(20px,5vw,80px)]">
        ...
        <h2 className="font-[var(--font-playfair)] text-[clamp(30px,4vw,48px)] font-black leading-[1.1] tracking-tight text-white mb-5 max-w-[800px]">The State of Rolling Paper <em className="italic text-[#E8C97A] font-bold">Manufacturing in 2026</em></h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
          {[
            ...
            <div key={i} className="border-l-2 border-[#C9A84C] pl-6 py-2">
              <div className="font-[var(--font-playfair)] text-[56px] font-black text-[#E8C97A] leading-none mb-2.5">{item.num}</div>
      ...
      {/* ── EDUCATIONAL BLOCKS ── */}
      <section className="py-24 px-[clamp(20px,5vw,80px)] bg-[#FAFAF7]">
        <span className="inline-block text-[11px] font-medium tracking-[0.14em] uppercase text-[#3B5E3A] mb-4">Manufacturer&apos;s Knowledge Base</span>
        <h2 className="font-[var(--font-playfair)] text-[clamp(30px,4vw,48px)] font-black leading-[1.1] tracking-tight text-[#1A1612] mb-5">Three Decisions That Define Your <em className="italic text-[#3B5E3A] font-bold">Rolling Paper Brand</em></h2>
        <p className="text-[17px] text-[#3D3630] font-light max-w-[720px] leading-relaxed mb-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white border border-[rgba(26,22,18,0.1)] border-l-[3px] border-l-[#3B5E3A] p-8">
            <h3 className="font-[var(--font-playfair)] text-[22px] font-bold text-[#3B5E3A] mb-3">GSM Explained</h3>
            <p className="text-[14.5px] text-[#3D3630] leading-relaxed mb-3"><strong>GSM</strong> stands for grams per square meter — the standard global measure of rolling paper thickness. Lower GSM = thinner paper.</p>
            <p className="text-[14.5px] text-[#3D3630] leading-relaxed mb-3">Premium brands typically choose <strong>12–14 GSM</strong> for quality. Mid-market brands pick <strong>14–18 GSM</strong> for balance. Value brands run <strong>18–25 GSM</strong> for cost efficiency.</p>
            <p className="text-[14.5px] text-[#3D3630] leading-relaxed">Recommendation: <strong>14 GSM rice or hemp.</strong> Broadest market acceptance and best margins.</p>
          </div>
          <div className="bg-white border border-[rgba(26,22,18,0.1)] border-l-[3px] border-l-[#3B5E3A] p-8">
            <h3 className="font-[var(--font-playfair)] text-[22px] font-bold text-[#3B5E3A] mb-3">Gum Types</h3>
            <p className="text-[14.5px] text-[#3D3630] leading-relaxed mb-3">The gum strip is what makes a rolling paper functional. Three options:</p>
            <p className="text-[14.5px] text-[#3D3630] leading-relaxed mb-3"><strong>Natural gum arabic</strong> — sourced from Acacia trees. Plant-based, food-safe, no aftertaste. The premium standard. RYO Papers&apos; default.</p>
            <p className="text-[14.5px] text-[#3D3630] leading-relaxed"><strong>Synthetic / Hybrid</strong> — cost-efficient but increasingly avoided by health-positioned brands.</p>
          </div>
          <div className="bg-white border border-[rgba(26,22,18,0.1)] border-l-[3px] border-l-[#3B5E3A] p-8">
            <h3 className="font-[var(--font-playfair)] text-[22px] font-bold text-[#3B5E3A] mb-3">MOQ Economics</h3>
            <p className="text-[14.5px] text-[#3D3630] leading-relaxed mb-3">Most factories require <strong>10,000–50,000 pack MOQs.</strong> This kills new brands before they start — locking $20K+ in inventory.</p>
            <p className="text-[14.5px] text-[#3D3630] leading-relaxed mb-3">RYO Papers manufactures from <strong>500 packs.</strong> Validate market response, refine packaging, and build cash flow before scaling.</p>
            <p className="text-[14.5px] text-[#3D3630] leading-relaxed">Data: <strong>68% of brands</strong> launching at 500 MOQ reorder within 6 months.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-[clamp(20px,5vw,80px)]">
        <span className="inline-block text-[11px] font-medium tracking-[0.14em] uppercase text-[#3B5E3A] mb-4">Why RYO Papers</span>
        <h2 className="font-[var(--font-playfair)] text-[clamp(30px,4vw,48px)] font-black leading-[1.1] tracking-tight text-[#1A1612] mb-5">Built for Brands, <em className="italic text-[#3B5E3A] font-bold">Not Just Buyers.</em></h2>
        <p className="text-[17px] text-[#3D3630] font-light max-w-[720px] leading-relaxed mb-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <FadeUp key={i} delay={0.1 * i} className="py-2">
              ...
              <h3 className="font-[var(--font-playfair)] text-[19px] font-bold text-[#1A1612] mb-2.5">{item.title}</h3>
      ...
      {/* ── TESTIMONIALS ── */}
      <section className="py-24 px-[clamp(20px,5vw,80px)] bg-[#FAFAF7]">
        <span className="inline-block text-[11px] font-medium tracking-[0.14em] uppercase text-[#3B5E3A] mb-4">Client Voices</span>
        <h2 className="font-[var(--font-playfair)] text-[clamp(30px,4vw,48px)] leading-[1.1] tracking-tight text-[#1A1612] mb-5">Brands That Trust <em className="italic text-[#3B5E3A] font-bold">Our Manufacturing.</em></h2>
        <p className="text-[17px] text-[#3D3630] font-light max-w-[720px] leading-relaxed mb-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <FadeUp
              key={i}
              delay={0.1 * i}
              className="bg-white border border-[rgba(26,22,18,0.1)] p-8 rounded relative before:content-['\'] before:absolute before:-top-2 before:left-6 before:font-[var(--font-playfair)] before:text-[80px] before:text-[#3B5E3A] before:leading-none before:bg-white before:px-2"
            >
              <p className="text-[15px] text-[#3D3630] leading-relaxed italic mb-5 mt-2">{t.text}</p>
              <p className="font-[var(--font-playfair)] text-base text-[#1A1612]">{t.author}</p>
      ...
      {/* ── CTA ── */}
      <div className="bg-[#1A1612] text-white py-20 px-[clamp(20px,5vw,80px)] flex items-center justify-between gap-10 flex-wrap">
        <div>
          <h2 className="font-[var(--font-playfair)] text-[clamp(28px,3.5vw,44px)] font-black leading-[1.1] tracking-tight text-white mb-2">
            Ready to <em className="italic text-[#E8C97A] font-bold">Manufacture</em> Your Brand?
          </h2>
        ...
        <div className="flex gap-3.5 flex-wrap shrink-0">
          <Link
            href="/contact"
            className="bg-[#C9A84C] text-[#1A1612] py-3.5 px-8 rounded-sm text-sm font-medium tracking-wider uppercase transition-all duration-200 hover:bg-[#E8C97A]"
          >
            Request a Quote
          </Link>
          <a
            href="https://wa.me/+919009111088?text=Hello!%20I%20want%20to%20enquire%20about%20rolling%20paper%20manufacturing."
            className="border-[1.5px] border-[rgba(255,255,255,0.3)] text-white py-3 px-7 rounded-sm text-sm font-medium tracking-wider uppercase transition-colors duration-200 hover:border-[rgba(255,255,255,0.7)]"
          >
            WhatsApp Us
          </a>
        </div>
